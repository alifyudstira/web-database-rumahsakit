...
<body class="bg-gray-100">
    <div class="flex min-h-screen">
        ...
        include "../koneksi.php";
        $id = $_GET['id'];
        $query = "select * from perawat where ID_Perawat=$id";
        ...
        <div class="flex-1 p-10">
            <div class="flex justify-center">
                <form action="../action/action_edit.php?id=<?php echo $id; ?>" method="POST" 
                    ...
                    <h2 class="text-lg font-semibold text-gray-700 mb-4">Edit Perawat</h2>
                    
                    <label class="block text-sm font-medium text-gray-700 mb-1">Nama Perawat</label>
                    <input type="text" name="nama_perawat" value="<?php echo $data['Nama_Perawat']; ?>"
                    ...
                    <button type="submit" name="edit" value="edit_perawat" class="w-full bg-green-500 text-white py-2 rounded-md hover:bg-green-600 transition">
                        Tambah
                    </button>
                </form>
            </div>
