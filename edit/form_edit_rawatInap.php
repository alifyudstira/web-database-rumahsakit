    ...
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 p-10">
            <div class="flex justify-center">
                <form action="../action/action_tambah.php?id=<?php echo $id; ?>" method="POST" 
                    class="bg-gray-200 p-6 rounded-xl shadow-md w-full max-w-md">

                    <!-- sinyal agar action_tambah tahu data apa yang ditambah -->
                    <input type="hidden" name="aksi" value="tambah_rawat_inap">

                    <h2 class="text-lg font-semibold text-gray-700 mb-4">Tambah Rawat Inap</h2>
                    ...
                    <input type="datetime-local" name="tgl_keluar" 
                        class="w-full p-2 mb-3 rounded-md bg-gray-100 border border-gray-300 focus:ring-2 focus:ring-sky-400 focus:outline-none">

                    <label class="block text-sm font-medium text-gray-700 mb-1">Diagnosa Awal</label>
                    <input type="text" name="diagnosa_awal" 
                        class="w-full p-2 mb-3 rounded-md bg-gray-100 border border-gray-300 focus:ring-2 focus:ring-sky-400 focus:outline-none" 
                        placeholder="Masukkan diagnosa awal" required>

                    <label class="block text-sm font-medium text-gray-700 mb-1">ID Pasien</label>
                    <input type="number" name="id_pasien" 
                        class="w-full p-2 mb-3 rounded-md bg-gray-100 border border-gray-300 focus:ring-2 focus:ring-sky-400 focus:outline-none" 
                        placeholder="Masukkan ID pasien" required>

                    <label class="block text-sm font-medium text-gray-700 mb-1">ID Dokter</label>
                    <input type="number" name="id_dokter" 
                        class="w-full p-2 mb-3 rounded-md bg-gray-100 border border-gray-300 focus:ring-2 focus:ring-sky-400 focus:outline-none" 
                        placeholder="Masukkan ID dokter" required>

                    <label class="block text-sm font-medium text-gray-700 mb-1">ID Kamar</label>
                    <input type="number" name="id_kamar" 
                        ...
                        placeholder="Masukkan ID kamar" required>

                    <button type="submit" name="tambah" value="tambah_rawatInap" class="w-full bg-green-500 text-white py-2 rounded-md hover:bg-green-600 transition">
                        Tambah
                    </button>
                </form>
            </div>
