...
<body class="bg-gray-100">
    <div class="flex min-h-screen">
        ...
        include "../koneksi.php";
        $id = $_GET['id'];
        $query = "select * from jadwal_jaga where ID_Jadwal_Jaga=$id";
        ...
        <div class="flex-1 p-10">
            <div class="flex justify-center">
                <form action="../action/action_edit.php?id=<?php echo $id; ?>" method="POST" 
                    ...
                    <h2 class="text-lg font-semibold text-gray-700 mb-4">Edit Jadwal Jaga</h2>
                    ...
                    <input type="number" name="id_perawat" value="<?php echo $data['ID_Perawat']; ?>"
                    ...
                    <button type="submit" name="edit" value="edit_jadwalJaga" class="w-full bg-green-500 text-white py-2 rounded-md hover:bg-green-600 transition">
                        Edit
                    </button>
                </form>
            </div>
