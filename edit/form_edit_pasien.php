        ...
        <div class="flex-1 p-10">
            <div class="flex justify-center">
                <form action="../action/action_edit.php?id=<?php echo $id; ?>" method="POST" 
                    ...
                    <h2 class="text-lg font-semibold text-gray-700 mb-4">Edit Pasien</h2>
                    ...
                    <button type="submit" name="edit" value="edit_pasien" class="w-full bg-green-500 text-white py-2 rounded-md hover:bg-green-600 transition">
                        Edit
                    </button>
                </form>
            </div>
