        ...
        <div class="flex-1 p-10">
            <div class="flex justify-center">
                <form action="../action/action_edit.php?id=<?php echo $id; ?>" method="POST" 
                    ...
                    <h2 class="text-lg font-semibold text-gray-700 mb-4">Edit Dokter</h2>
                    ...
                    <input type="text" name="spesialisasi" value="<?php echo $data['Spesialisasi']; ?>"
                        class="w-full p-2 mb-3 rounded-md bg-gray-100 border border-gray-300 focus:ring-2 focus:ring-sky-400 focus:outline-none" 
                        placeholder="Masukkan bidang spesialis" required>
                    ...
                    <button type="submit" name="edit" value="edit_dokter" class="w-full bg-green-500 text-white py-2 rounded-md hover:bg-green-600 transition">
                        Edit
                    </button>
                </form>
            </div>
