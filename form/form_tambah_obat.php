        ...
        <div class="flex-1 p-10">
            <div class="flex justify-center">
                <form action="../action/action_tambah.php" method="POST" 
                    ...
                    <h2 class="text-lg font-semibold text-gray-700 mb-4">Tambah Obat</h2>
                    ...
                    <button type="submit" name="tambah" value="tambah_obat" class="w-full bg-green-500 text-white py-2 rounded-md hover:bg-green-600 transition">
                        Tambah
                    </button>
                </form>
            </div>
