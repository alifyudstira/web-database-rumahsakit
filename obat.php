...
<body class="bg-gray-100">
  ...
  <div class="flex min-h-screen">
    ...
    <aside class="w-56 bg-green-200 p-6 flex flex-col justify-between shadow-md">
      <div>
        ...
        <nav class="flex flex-col gap-3 text-gray-800 text-sm">
          <a href="#" class="py-2 px-3 rounded-lg hover:bg-green-300 hover:translate-x-1 transition-all duration-200">Daftar Dokter</a>
          ...
          <a href="obat.php" class="py-2 px-3 rounded-lg hover:bg-green-300 hover:translate-x-1 transition-all duration-200"><b>Daftar Obat</b></a>
    ...
    <main class="flex-1 p-8">
      <div class="mb-5"><a href="form/form_tambah_obat.php" class="inline-block text-black hover:bg-green-500 border border-green-500 px-3 py-1 rounded-lg transition"><button>Tambah</button></a></div>
          ...
          <thead>
            ...
            foreach($data as $item){
                ...
                <tbody class='divide-y divide-gray-100'>
                    ...
                    <td class='italic px-6 py-3'>".$item['ID_Obat']."</td>
                    <td class='italic px-6 py-3'>".$item['Nama_Obat']."</td>
                    <td class='italic px-6 py-3'>".$item['Stok']."</td>
                    <td class='italic px-6 py-3'>".$item['Harga']."</td>
                    <td class='italic px-6 py-3'>
                      <div class='grid grid-cols-2 gap-3'>
                        <a href='action/action_hapus.php?hapus=obat&id=".$item['ID_Obat']."' class='inline-block text-red-600 hover:text-white hover:bg-red-600 border border-red-600 px-3 py-1 rounded-lg transition'>Hapus</a>

                        <a href='edit/form_edit_obat.php?id=".$item['ID_Obat']."' class='inline-block text-green-600 hover:text-white hover:bg-green-600 border border-green-600 px-3 py-1 rounded-lg transition'>Edit</a>
                      </div>
                    </td>
                    </tr>
                </tbody>
